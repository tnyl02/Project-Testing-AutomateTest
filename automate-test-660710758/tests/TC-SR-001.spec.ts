...
test('TC-SR-001', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'ค้นหาเลขที่ใบคำสั่งปฏิบัติงาน' }).click();
  await page.getByRole('textbox', { name: 'ค้นหาเลขที่ใบคำสั่งปฏิบัติงาน' }).fill('69040002');
